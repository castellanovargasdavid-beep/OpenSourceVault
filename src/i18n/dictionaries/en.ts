...
const en: Dictionary = {
  ...
  toolPage: {
    ...
    comparisonTitle: "💡 Official SaaS or self-hosted with AltFreeStack?",
    comparisonCloudLabel: "On the official cloud:",
  ...
  stackBuilder: {
    ...
    defaultProjectName: "My Stack",
    addButton: "+ Add to My Stack",
    addedButton: "✓ In your Stack",
    widgetTooltip: "View my Stack Builder",
    toolSingular: "tool",
    toolPlural: "tools",
    metaTitle: "Stack Builder — build your open source infrastructure",
    metaDescription:
      "Pick several tools from the catalog and generate a single docker-compose.yml ready to deploy, no sign-up or database required.",
    badge: "No sign-up · Saved in your browser",
    pageTitle: "Build your stack",
    pageSubtitle:
      "Add tools from the catalog, see how much RAM you need and how much you're saving, and download a single docker-compose.yml with everything ready to deploy.",
    projectLabel: "Project",
    newProjectButton: "+ New project",
    newProjectPrompt: "Name of the new project",
    renameProjectButton: "Rename",
    renameProjectPrompt: "New project name",
    deleteProjectButton: "Delete project",
    deleteProjectConfirm: "Delete this project and the tools saved in it? This can't be undone.",
    emptyStateTitle: "Your stack is still empty",
    emptyStateBody: "Search for tools below, or click \"+ Add to My Stack\" on any tool in the catalog.",
    searchPlaceholder: "Search for a tool to add...",
    searchNoResults: "No tools match.",
    selectedToolsTitle: "Tools in this stack",
    removeToolLabel: "Remove from stack",
    metricsTitle: "Stack summary",
    ramLabel: "Combined minimum RAM",
    savingsLabel: "Estimated SaaS savings",
    savingsPerMonth: "/mo",
    savingsPerYear: "/yr",
    savingsNote: "Estimated per user, based on the public price of the SaaS tools this stack replaces.",
    savingsUnavailable: "We don't have public SaaS pricing for any tool in this stack yet.",
    generateButton: "Generate unified docker-compose",
    generatingLabel: "Generating...",
    generateError: "Couldn't generate the file. Try again.",
    downloadButton: "Download docker-compose.yml",
    copyButton: "Copy",
    copiedLabel: "Copied",
    shareButton: "Share my Stack",
    shareCopied: "Link copied!",
    shareDescription: "Anyone who opens this link sees exactly these tools, ready to import into their own stack.",
    warningsTitle: "Notes from merging the files",
