...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${siteConfig.url}/en/saas-exit`,
    languages: { es: `${siteConfig.url}/saas-exit`, en: `${siteConfig.url}/en/saas-exit` },
  },
};

export default function EnglishSaasExitPage() {
  const catalog = buildSaasExitCatalog("en");
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <SaasExitContent catalog={catalog} locale="en" t={t.saasExit} hardwareT={t.hardwareFit} hostingTierT={t.hostingTier} />
    </div>
  );
}
